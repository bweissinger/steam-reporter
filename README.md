...
First copy the default config file to your preferred location.

```cp default/config.ini /your/preferred/location/```

Open the config file with your editor of choice and complete the settings.
...
If you router your steam emails to a specific folder within your inbox, make sure to uncomment this line and add the name of the folder. If they are located in your main inbox, leave it commented out.
